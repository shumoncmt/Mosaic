<footer class="ftco-footer ftco-bg-dark ftco-section">
          ...
          <div class="col-md">
            <div class="ftco-footer-widget mb-4 ml-md-4">
              ...
              <ul class="list-unstyled">
                ...
                <li><a href={{route('service')}}><span class="icon-long-arrow-right mr-2"></span>Services</a></li>
  ...
  Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with by Md. Shumon Mia
